...
var SidebarMenuButton = React.forwardRef(function (_a, ref) {
    ...
    var button = (React.createElement(Comp, __assign({ ref: ref, "data-sidebar": "menu-button", "data-size": size, "data-active": isActive, className: utils_1.cn(sidebarMenuButtonVariants({ variant: variant, size: size, className: className })) }, props)));
    if (!tooltip) {
        return button;
    }
