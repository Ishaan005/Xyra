                            ...
                            <td className="p-4">
                              <div className="space-y-1">
                                ...
                                <div className="text-xs text-muted-foreground space-y-1">
                                  ...
                                  {item.item_metadata?.outcome_count && (
                                    <div className="flex items-center gap-1">
                                      <span className="inline-block w-2 h-2 bg-purple-300 rounded-full"></span>
                                      <span>Outcome Count: {item.item_metadata.outcome_count}</span>
                                    </div>
                                  )}
                                  {item.item_metadata?.percentage_fee && item.item_metadata.percentage_fee > 0 && (
                                    <div className="flex items-center gap-1">
                                      <span className="inline-block w-2 h-2 bg-blue-300 rounded-full"></span>
                                      <span>Percentage Fee: ${item.item_metadata.percentage_fee.toFixed(2)}</span>
                                    </div>
                                  )}
                                  {item.item_metadata?.fixed_fee && item.item_metadata.fixed_fee > 0 && (
                                    <div className="flex items-center gap-1">
                                      <span className="inline-block w-2 h-2 bg-green-300 rounded-full"></span>
                                      <span>Fixed Fee: ${item.item_metadata.fixed_fee.toFixed(2)}</span>
                                    </div>
                                  )}
                                  {item.item_metadata?.outcome_type && (
                                    <div className="flex items-center gap-1">
                                      <span className="inline-block w-2 h-2 bg-purple-300 rounded-full"></span>
                                      <span>Type: {item.item_metadata.outcome_type}</span>
                                    </div>
                                  )}
